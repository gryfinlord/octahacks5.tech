	...
	return (
		<div className="textContainer flex-1 flex flex-col md:gap-10 justify-center text-center">
			<div className="w-full  h-full flex flex-col justify-center items-center text-white bg-transparent cursor-pointer space-y-4 p-4 text-center">
				<h1 className="text-4xl lg:text-5xl xl:text-6xl font-normal text-transparent bg-gradient-to-r from-[#6c6aff] via-[#fbc7d4] to-[#ff658b] inline-block bg-clip-text text-center">
					Tracks
				</h1>
				<p className="text-[1rem] lg:text-[1.2rem] xl:text-[1.4rem] font-light lg:text-center text-center mx-8">
