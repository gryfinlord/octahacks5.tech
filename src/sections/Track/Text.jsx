	...
	return (
		<div className="textContainer flex-1 flex flex-col md:gap-10 justify-center text-center">
			<div className="w-full  h-full flex flex-col justify-center items-center lg:items-start text-white bg-transparent cursor-pointer space-y-4 p-4 text-center">
				<h1 className="text-4xl lg:text-5xl xl:text-6xl font-semibold text-transparent bg-gradient-to-r from-[#6c6aff] via-[#fbc7d4] to-[#ff658b] inline-block bg-clip-text text-center mt-4">
					Tracks
				</h1>
				<p className="text-[1.2rem] lg:text-[1.3rem] xl:text-[1.5rem] md:w-[90%] p-4 lg:text-start text-center font-regular">
