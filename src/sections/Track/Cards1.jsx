	...
	return (
		<div className="md:flex-1 ">
			<div className="md:space-y-8 space-y-3 md:mx-7 mx-2 my-4 bg-slate-900 px-4 py-6 h-[90vh] rounded-md overflow-y-hidden">
				...
				{/* card1 */}
				<div className="flex-col text-center items-center justify-center p-6 relative flex overflow-y-hidden group overflow-y-scroll scroll">
					<div className="animate-marqueeT lg:group-hover:pause xl:group-hover:pause xxl:group-hover:pause md:group-hover:animate-marqueeT gap-4 flex flex-col">
					...
					<div className="absolute whitespace-normal px-6 animate-marqueeT2 md:group-hover:animate-marqueeT2  group-hover:pause gap-4 flex flex-col mt-8">
						<div className="flex flex-col md:flex-row justify-evenly md:space-x-4 space-y-8 md:space-y-0 items-center p-5 rounded-xl  bg-slate-800 bg-opacity-60 border border-gray-200">
							<div className="md:w-[55%] ">
								<div className="flex flex-row justify-between items-center">
									<p className="titlePara">Smart City</p>
