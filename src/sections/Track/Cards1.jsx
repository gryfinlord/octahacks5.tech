	...
	return (
		<div className="md:flex-1 mx-8 md:mx-2 sm:mx-0 xs:ms-0 ">
			<div className="scroll  md:space-y-8 space-y-3 md:mx-7 mx-1 my-4 bg-slate-900 px-4 py-6 h-[75vh] rounded-md overflow-y-scroll flex flex-row flex-wrap w-fit gap-x-8 lg:space-y-4 text-center justify-center">
				{/* card1 */}
				<div className="p-5 rounded-xl shadow-xl shadow-slate-900 bg-slate-800 basis-1/5 py-8 mt-4">
				...
				<div className=" p-5 rounded-xl shadow-xl shadow-slate-900 bg-slate-800 basis-1/5 py-8">
				...
				<div className=" items-center p-5 rounded-xl shadow-xl shadow-slate-900 bg-slate-800 basis-1/5 py-8">
					<div className="md:w-[100%]">
						<div className="">
