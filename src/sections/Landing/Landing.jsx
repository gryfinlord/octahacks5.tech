...
const Landing = () => {
	...
	return (
		<div
			id="home"
			className=" flex relative flex-col flex-1 snap-start h-screen bg-[url(https://github.com/YAKSHIT-22/Cyber_Threat_Analysis_Website/blob/main/ezgif.com-gif-maker.gif?raw=true)] bg-no-repeat bg-cover bg-center"
		>
			<div className="h-screen backdrop-blur-[2px]">
			<div className="w-full bg-transparent h-[15vh]">
			...
			<div className="flex relative flex-row flex-1 h-[85vh]">
			<div
				className="w-full h-full flex flex-col justify-center items-center "
			>
				<div className="w-2/3 text-md p-1 xl:text-5xl lg:text-3xl md:text-2xl sm:text-xl xs:text-lg text-center">
					<p>"TECH IT EASY"</p>
				</div>

				<div className="w-full text-4xl p-2 xl:text-9xl lg:text-8xl md:text-8xl sm:text-7xl xs:text-5xl text-center">
				...
				<button className="p-2 group w-1/3 flex items-center justify-center gap-4 sm:text-sm md:text-md lg:text-xl">
					Apply With Devfolio
			...
			<div className="flex-col justify-center item-center flex absolute right-16 gap-[1px] bottom-6">
				<img
					alt="socials"
