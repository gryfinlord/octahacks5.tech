...
function Prizes() {
	return (
		<div
			id="prizes"
			className="bg-no-repeat bg-contain grid sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 w-full xl:h-[84%] lg:h-[84%] "
		>
			<div className="flex flex-col justify-center items-center">
				<div className="p-2 flex flex-col justify-center items-center lg:items-start lg:ml-1">
					...
					<h1 className="mt-6 text-4xl lg:text-5xl xl:text-6xl font-semibold text-transparent bg-gradient-to-r from-[#6c6aff] via-[#fbc7d4] to-[#ff658b] inline-block bg-clip-text text-center">
				Prizes
				</h1>
				<p className="text-[1.2rem] lg:text-[1.3rem] xl:text-[1.5rem] w-5/6 lg:w-full p-4 lg:p-0 text-center lg:text-start font-regular">
			...
			<div className="flex flex-col justify-center items-center">
				...
				<div className="w-full h-full flex flex-col justify-center items-center text-white bg-gray-800 p-2 rounded-[4px]">
					...
					<div className="w-full h-full flex flex-col justify-center items-center text-white bg-gray-800 p-2 cursor-pointer rounded-[4px]">
						<h2 className="text-xl  font-semibold p-[2%] text-center">2nd Runner Up</h2>
