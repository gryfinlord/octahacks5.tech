...
function Prizes() {
	return (
		<div
			id="prizes"
			className="bg-slate-900 bg-[url(https://github.com/YAKSHIT-22/Cyber_Threat_Analysis_Website/blob/main/ezgif.com-gif-maker.gif?raw=true)] bg-no-repeat bg-cover bg-center  w-full h-full"
		>
			<div className="backdrop-blur-md flex items-center justify-center flex-col w-screen">
			<div className="flex flex-col justify-center items-center">
				<div className="md:p-2 flex flex-col justify-center items-center">
					<div className="md:w-full lg:w-[88%] h-full flex flex-col justify-center items-center  text-white bg-transparent  cursor-pointer space-y-4 ">	
						<h1 className="text-5xl text-center lg:text-6xl xl:text-7xl font-semibold text-transparent bg-gradient-to-r from-[#6c6aff] via-[#fbc7d4] to-[#ff658b] inline-block bg-clip-text">
							Prizes
						</h1>
						<p className="text-[1rem] lg:text-[1.2rem] xl:text-[1.4rem] font-medium text-center">
			...
			<div className="flex flex-col justify-center items-center p-4 w-full h-full">
				<div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 w-full items-center p-4 gap-6 h-full">
					<div className="w-full h-full flex flex-col justify-center items-center text-white bg-gray-800 p-2 cursor-pointer rounded-[4px]">
						...
						<h1 className="text-[2rem] font-semibold text-center">₹ 15,000*</h1>
					...
					<div className="w-full h-full flex flex-col justify-center items-center text-white bg-gray-800 p-2 cursor-pointer rounded-[4px]">
						...
						<h1 className="text-[2rem] font-semibold text-center">₹ 10,000*</h1>
						<p className="text-[.5rem] lg:text-[.8rem] text-center">
							+Goodies worth upto
						</p>
						<p>₹ 75 Thousand</p>
					...
					<div className="w-full h-full flex flex-col justify-center items-center text-white bg-gray-800 p-2 cursor-pointer rounded-[4px]">
						...
						<h1 className="text-[2rem] font-semibold text-center">₹ 5,000*</h1>
						<p className="text-[.5rem] lg:text-[.8rem] text-center">
							+Goodies worth upto
						</p>
						<p>₹ 30 Thousand</p>
					...
					<div className="w-full h-full flex flex-col justify-center items-center text-white bg-gray-800 p-2 cursor-pointer rounded-[4px] space-y-4">
						<h2 className="h-auto w-[28%] sm:w-1/2 md:w-[50%] flex flex-col justify-center items-center">
							<img alt="imageSponsors" src={require("../assets/Sponsors/tezos.svg").default} />
						</h2>
						<p className="text-[.7rem]  md:text-[.6rem] lg:text-[.8rem] text-center font-medium">
					...
					<div className="w-full h-full flex flex-col justify-center items-center text-white bg-gray-800 p-2 cursor-pointer rounded-[4px] space-y-2">
						<h2 className="h-auto w-[28%] sm:w-1/2 md:w-[45%] flex flex-col justify-center items-center">
