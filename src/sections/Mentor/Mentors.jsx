		...
		>
			...
			<div class="grid sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6 px-6 xs:px-12 py-12 md:px-6 md:py-6 xl:px-12 xl:py-12 auto-rows-fr bg-slate-900">
				<div
					...
					class="w-full bg-white rounded-lg shadow-lg overflow-hidden flex flex-col justify-center items-center"
				>
					{/* <div>
				...
				>
					{/* <div>
						<img
							class="object-fill object-center  w-full h-auto"
							src={require("../../assets/mentor/2.jpg")}
							alt="photo"
						/>
					</div>
					...
					<div class="flex flex-row items-center justify-center gap-2 mb-4">
						<a
							href="https://www.linkedin.com/in/sourav-sourav-5aa882195/"
							class=""
						>
							<img
				...
				>
					{/* <div>
						<img
							class="object-fill object-center   h-auto w-full"
							src={require("../../assets/mentor/3.jpg")}
							alt="photo"
						/>
					</div>
					<div class="text-center py-8 sm:py-6">
					...
					<div class="flex flex-row items-center justify-center gap-2 mb-4">
						<a
							href="https://www.linkedin.com/in/gautam-sood-55bb84232/"
							class=""
						>
							<img
								src={require("../../assets/linkedin.png")}
				...
				>
					{/* <div>
						<img
							class="object-fill object-center   h-auto w-full"
							src={require("../../assets/mentor/4.jpg")}
							alt="photo"
						/>
					</div>
					<div class="text-center py-8 sm:py-6">
					...
					<div class="flex flex-row items-center justify-center gap-2 mb-4">
						<a
							href="https://www.linkedin.com/in/kartik-sharma-a5618b194/"
							class=""
						>
							<img
								src={require("../../assets/linkedin.png")}
				...
				>
					...
					{/* Ek change kar rakha hai bas for height diff last mein h-64 hai */}
				</div>
			</div>
		</div>
	);
