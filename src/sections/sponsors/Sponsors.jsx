...
{/* left div----------------------------------------------------------------------------------------- */}
      ...
      <div className='w-full'>
        <div className='font-bold text-4xl sm:text-5xl text-white pb-4 p-4 mt-2'><h1>Our <span className='font-semibold text-4xl sm:text-5xl 
...
{/* right div -----------------------------------------------------------------------------------*/}
      ...
      <div className=' w-full justify-center text-center items-center'>
          ...
          <div className='flex justify-center gap-6 p-4 flex-wrap items-center'>
            ...
            {/* Premium Sponsors ------------------------------------------------------------------------ */}
            <div className='mb-[20%] bg-white flex flex-col items-center justify-center bg-opacity-10 backdrop-filter backdrop-blur-lg  h-full rounded-lg shadow-x overflow-hidden m-4  w-full p-4'><div><h1 className='text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600  p-2'>Premium Sponsors</h1></div>
